...
int Java_com_arifin_missilelauncherclient_MjpegInputStream_pixeltobmp( JNIEnv* env,jobject thiz,
...
void Java_com_arifin_missilelauncherclient_MjpegInputStream_freeCameraMemory( JNIEnv* env,jobject thiz){
